        ...
        try {
            ...
            if (!unitValidator.isValid(String.valueOf(unitOfMeasure), true))
                throw new IllegalArgumentException(
                        "Invalid value for unit of measure. Should be one of KLOGRAMS, METERS, LITERS, MILLILITERS");

            String ownerName = tokens[6].trim();
            if (ownerName.isBlank())
                addIfMax(name, coordinates, !price.isBlank() ? Double.parseDouble(price) : null,
