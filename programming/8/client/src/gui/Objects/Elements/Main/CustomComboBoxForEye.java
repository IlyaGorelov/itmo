...
public class CustomComboBoxForEye extends JComboBox<EyeColor> {
    public CustomComboBoxForEye(EyeColor[] items) {
        super(items);
        ...
        setUI(new CustomComboBoxForEye.PurpleComboBoxUI());
        ...
        setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(
                ...
                if (value == null) {
                    ...
                    c.setText(EnumI18n.eyeColor((EyeColor) value));
                }
