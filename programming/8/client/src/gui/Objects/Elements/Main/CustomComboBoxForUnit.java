...
public class CustomComboBoxForUnit extends JComboBox<UnitOfMeasure> {
    public CustomComboBoxForUnit(UnitOfMeasure[] items) {
        super(items);
        ...
        setUI(new CustomComboBoxForUnit.PurpleComboBoxUI());
        ...
        setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(
                ...
                if (value == null) {
                    ...
                    c.setText(EnumI18n.unitOfMeasure((UnitOfMeasure) value));
                }
